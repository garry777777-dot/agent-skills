...
### Grow - Cost-efficient GTM automation

| Skill | What It Does | Use When |
|-------|-------------|----------|
| [lead-generation-and-cold-outbound](skills/lead-generation-and-cold-outbound/SKILL.md) | Waterfall company/contact sourcing, self-correcting recurring jobs, goal-mode list contracts, a recurring campaign-optimization loop, and open-source fallbacks over paid SaaS | Building or automating a cold-outbound lead list, or cutting GTM tooling spend |
...
│   ├── lead-generation-and-cold-outbound/ # Grow
